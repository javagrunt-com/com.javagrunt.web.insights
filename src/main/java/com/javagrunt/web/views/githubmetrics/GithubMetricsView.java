package com.javagrunt.web.views.githubmetrics;


import com.javagrunt.web.views.MainLayout;
import com.javagrunt.web.views.githubmetrics.ServiceHealth.Status;
...
@PageTitle("Github Metrics")
@Route(value = "github-metrics", layout = MainLayout.class)
@AnonymousAllowed
public class GithubMetricsView extends Main {

    public GithubMetricsView() {
        addClassName("github-metrics-view");
