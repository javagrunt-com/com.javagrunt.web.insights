package com.javagrunt.web.views.eventstream;
...
@Route(value = "event-stream", layout = MainLayout.class)
@PermitAll
public class EventStreamView extends HorizontalLayout {
    ...
    public EventStreamView() {
        addClassNames("event-stream-view", Width.FULL, Display.FLEX, Flex.AUTO);
        setSpacing(false);
