package com.javagrunt.web.views.twitchmetrics;


import com.javagrunt.web.views.MainLayout;
import com.javagrunt.web.views.twitchmetrics.ServiceHealth.Status;
...
@PageTitle("Twitch Metrics")
@Route(value = "twitch-metrics", layout = MainLayout.class)
@AnonymousAllowed
public class TwitchMetricsView extends Main {

    public TwitchMetricsView() {
        addClassName("twitch-metrics-view");
