package com.javagrunt.web.views.youtubemetrics;


import com.javagrunt.web.views.MainLayout;
import com.javagrunt.web.views.youtubemetrics.ServiceHealth.Status;
...
@PageTitle("Youtube Metrics")
@Route(value = "youtube-metrics", layout = MainLayout.class)
@AnonymousAllowed
public class YoutubeMetricsView extends Main {

    public YoutubeMetricsView() {
        addClassName("youtube-metrics-view");
