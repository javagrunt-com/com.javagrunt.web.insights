package com.javagrunt.web.views.youtubevideos;
...
@Route(value = "youtube-videos", layout = MainLayout.class)
@AnonymousAllowed
public class YoutubeVideosView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public YoutubeVideosView() {
        addClassName("youtube-videos-view");
        setSizeFull();
        grid.setHeight("100%");
